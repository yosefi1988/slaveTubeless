package ir.sajjadyosefi.tubeless.radyab.slavetubeless.activity.testActivities;
...
public class GpsTestActivity extends AppCompatActivity {
                        ...
                        switch (statusCode) {
                            case LocationSettingsStatusCodes.RESOLUTION_REQUIRED:
                                ...
                                try {
                                    ...
                                    rae.startResolutionForResult(GpsTestActivity.this, REQUEST_CHECK_SETTINGS);
                            ...
                            case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                                ...
                                Toast.makeText(GpsTestActivity.this, errorMessage, Toast.LENGTH_LONG).show();
                        }
    ...
    public void startLocationButtonClick(View view) {
        ActivityCompat.requestPermissions(GpsTestActivity.this, new String[]{ACCESS_FINE_LOCATION}, 101);
    }
